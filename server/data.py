...
objects = [
    ...
    {'type': 'player', 'typeId': 27, 'health': 100, 'damage': 15, 'speed': 1.0, 'sight': 5, 'walkPause': 0.2, 'interactPause': 1.5, 'regeneration': 1, 'allowedBlocks': [0, 6, 20, 17, 13, 1, 3, 9, 19, 22], 'swimmingSkill': 0, 'inventory': [], 'equipped': {'head': None, 'back': None, 'hand': None, 'feet': None}, 'chestInventory': [], 'inventorySpace': 10, 'researchProgress': {}, 'skinChangePause': 0.5, 'getDataTimeout': 0.5},
...
items = [ # 'recipe': {id: amount}
    ...
    {'name': 'light_boots_tier_I', 'recipe': {29: 14, 28: 6}, 'typeId': 40, 'boosts': {'speed': 0.1}, 'bodySlot': ['feet'], 'research': 100.0},
    {'name': 'recipe_light_boots_tier_II', 'recipe': {}, 'typeId': 41, 'boosts': {}, 'bodySlot': [], 'research': 0.0},
    {'name': 'light_boots_tier_II', 'recipe': {31: 20, 32: 10}, 'typeId': 42, 'boosts': {'speed': 0.2}, 'bodySlot': ['feet'], 'research': 130.0},
    {'name': 'recipe_light_boots_tier_III', 'recipe': {}, 'typeId': 43, 'boosts': {}, 'bodySlot': [], 'research': 0.0},
    {'name': 'light_boots_tier_III', 'recipe': {35: 24, 34: 18}, 'typeId': 44, 'boosts': {'speed': 0.3, 'health': 2}, 'bodySlot': ['feet'], 'research': 160.0},
    {'name': 'recipe_light_boots_tier_IV', 'recipe': {}, 'typeId': 45, 'boosts': {}, 'bodySlot': [], 'research': 0.0},
    {'name': 'light_boots_tier_IV', 'recipe': {33: 23, 36: 15}, 'typeId': 46, 'boosts': {'speed': 0.4, 'health': 4}, 'bodySlot': ['feet'], 'research': 190.0},
    {'name': 'recipe_light_boots_tier_V', 'recipe': {}, 'typeId': 47, 'boosts': {}, 'bodySlot': [], 'research': 0.0},
    {'name': 'light_boots_tier_V', 'recipe': {38: 25, 37: 20}, 'typeId': 48, 'boosts': {'speed': 0.5, 'health': 8}, 'bodySlot': ['feet'], 'research': 220.0},
]
